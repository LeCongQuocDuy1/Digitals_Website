        ...
        <div className="middle-footer bg-[#191919] py-[50px]">
          <div className="w-main m-auto flex gap-[100px]">
            <div className="about-us relative">
                <span className="title uppercase text-[#ffffff] text-[15px] relative font-semibold mb-[20px] pl-[15px] before:content-[''] before:block before:absolute before:bg-main before:w-[3px] before:h-[100%]"> About us</span>
                <div className="info-ft mt-[20px]">
                    <ul className="flex-col flex gap-[10px] mb-[20px]">
                      <li>
                        <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" > 
                          <icons.MdPlace className="text-[16px] grid self-center"/>
                          <span className="font-normal">Adress:</span>
                          <span className="opacity-60">474 Ontario St Toronto, ON M4X 1M7 Canada</span>
                        </a>
                      </li>
                      <li>
                        <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" > 
                          ...
                          <span className="opacity-60">(+1234)56789xxx</span>
                        </a>
                      </li>
                      <li>
                        <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" > 
                          ...
                          <span className="opacity-60">tadathemes@gmail.com</span>
                        </a>
                      </li>
                    </ul>
                    <div className="list-social flex flex-row gap-[5px] text-[#ffffff] text-[16px]">
                      <a href="" className=" flex justify-center items-center text-[16px] rounded-[3px] h-[40px] w-[40px] bg-[rgba(255,255,255,.1)]">
                        <icons.FaFacebookF  />
                      </a>
                      <a href="" className="flex justify-center items-center text-[16px] rounded-[3px] h-[40px] w-[40px] bg-[rgba(255,255,255,.1)]">
                        <icons.FaTwitter  />
              ...
              <div className="information">
                  ...
                  <div className="info-ft mt-[20px]">
                      <ul className="flex-col flex gap-[10px] mb-[20px]">
                        ...
                        <li>
                          <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" >  
                            <span className="opacity-60">Store Location</span>
                          </a>
                        </li>
                        <li>
                          <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" >  
                            <span className="opacity-60">Today's Deals</span>
                          </a>
                        </li>
                        <li>
                          <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" >  
              ...
              <div className="who-we-are">
                ...
                <div className="info-ft mt-[20px]">
                    <ul className="flex-col flex gap-[10px] mb-[20px]">
                      ...
                      <li>
                        <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" >  
                          <span className="opacity-60">Free Shipping</span>
                        </a>
                      </li>
                      <li>
                        <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" >  
                      ...
                      <li>
                        <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" >  
                          <span className="opacity-60">Return & Exchange</span>
                        </a>
                      </li>
                      <li>
                        <a href="#" className="flex text-[#ffffff] text-[13px] gap-[5px]" >  
                          <span className="opacity-60">Testimonials</span>
                        </a>
                      </li>
                    </ul> 
                </div>
              ...
              <div className="tags-info flex ">
                {
                  product_tag.map((index)=>(
                    <a href="#" className="text-[#ffffff] text-[13px] relative opacity-60 px-[10px] border-r-[.1px] border-[#ffffffa6] last:border-r-[0px]">
                       {index.name}
                      { console.log("pdr tag",index.name)}
                      </a>
                  ))
                }
